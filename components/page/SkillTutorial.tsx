...
import { ClockIcon, CursorArrowRaysIcon, InboxArrowDownIcon } from '@heroicons/react/24/outline';
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-zinc-700 p-6 text-left shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    ...
                    <table className="table-auto text-left">
                      ...
                      <tbody>
                        <tr>
                          <td><ClockIcon className="inline h-10 shrink-0 mx-1 mr-2 text-rose-400"/></td>
                          <td>
                        ...
                        <tr>
                          <td><InboxArrowDownIcon className="inline h-10 shrink-0 mx-1 mr-2 text-fuchsia-400"/></td>
                          <td>
                            <div className="w-full text-left">
                        ...
                        <tr>
                          <td><CursorArrowRaysIcon className="inline h-10 shrink-0 mx-1 mr-2 text-blue-400"/></td>
                          <td>
                            <div className="w-full text-left">
